...
# @shell_orchestration: Shared plan-level status table belongs to CLI output surface.
def _build_phase_overview_table(p: Plan) -> Result[Table, str]:
    """Build the plan-level phase overview table used by status and top."""
