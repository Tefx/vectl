...
class TestInspectFamily:
    ...
    def test_orch_inspect_actions_exists(self):
        ...
        if result.returncode == 127:
            raise AssertionError("GAP [registration]: `vectl orch inspect status` not registered")
        elif result.returncode == 5:
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect status` app not wired - downstream green owner: orchestration app"
            )
        elif result.returncode == 2 and "not yet implemented" in result.stderr.lower():
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect status` orchestration app not implemented"
            )
    ...
    def test_orch_inspect_events_exists(self):
        ...
        if result.returncode == 127:
            raise AssertionError("GAP [registration]: `vectl orch inspect events` not registered")
        elif result.returncode == 5:
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect events` app not wired - downstream green owner: orchestration app"
            )
        elif result.returncode == 2 and "not yet implemented" in result.stderr.lower():
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect events` orchestration app not implemented"
            )
    ...
    def test_orch_inspect_logs_exists(self):
        ...
        if result.returncode == 127:
            raise AssertionError("GAP [registration]: `vectl orch inspect logs` not registered")
        elif result.returncode == 5:
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect logs` app not wired - downstream green owner: orchestration app"
            )
        elif result.returncode == 2 and "not yet implemented" in result.stderr.lower():
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect logs` orchestration app not implemented"
            )
    ...
    def test_orch_inspect_artifacts_exists(self):
        ...
        if result.returncode == 127:
            raise AssertionError(
                "GAP [registration]: `vectl orch inspect artifacts` not registered"
            )
        elif result.returncode == 5:
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect artifacts` app not wired - downstream green owner: orchestration app"
            )
        elif result.returncode == 2 and "not yet implemented" in result.stderr.lower():
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect artifacts` orchestration app not implemented"
            )
    ...
    def test_orch_inspect_actions_exists(self):
        ...
        if result.returncode == 127:
            raise AssertionError("GAP [registration]: `vectl orch inspect actions` not registered")
        elif result.returncode == 5:
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect actions` app not wired - downstream green owner: orchestration app"
            )
        elif result.returncode == 2 and "not yet implemented" in result.stderr.lower():
            raise AssertionError(
                "GAP [wiring]: `vectl orch inspect actions` orchestration app not implemented"
            )
