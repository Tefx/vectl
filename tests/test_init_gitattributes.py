...
def test_init_creates_gitattributes(tmp_path: Path) -> None:
...
def test_init_idempotent_gitattributes(tmp_path: Path) -> None:
...
def test_init_gitattributes_preserves_existing(tmp_path: Path) -> None:
